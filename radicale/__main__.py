...
def run() -> None:
    ...
    termination_signal_numbers = [signal.SIGTERM, signal.SIGINT]
    if os.name == "posix":
        termination_signal_numbers.append(signal.SIGHUP)
        termination_signal_numbers.append(signal.SIGQUIT)
    if sys.platform == "win32":
        termination_signal_numbers.append(signal.SIGBREAK)
    ...
    def exit_signal_handler(signal_number: "signal.Signals",
        ...
        sys.exit(1)
    for signal_number in termination_signal_numbers:
