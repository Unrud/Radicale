...
import sys
import threading
from typing import Any, Callable, ClassVar, Iterator, MutableMapping, Union
...
class IdentLogRecordFactory:
    ...
    def __init__(self,
                 upstream_factory: Callable[..., logging.LogRecord]) -> None:
...
class ThreadedStreamHandler(logging.Handler):
    ...
    def __init__(self) -> None:
        super().__init__()
        self._streams: MutableMapping[int, types.ErrorStream] = {}
