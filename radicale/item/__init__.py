...
def check_and_sanitize_props(
        props: MutableMapping[Any, Any]) -> MutableMapping[str, str]:
...
def find_available_uid(
        exists_fn: Callable[[str], bool], suffix: str = "") -> str:
...
def find_time_range(
        vobject_item: vobject.base.Component, tag: str) -> Tuple[int, int]:
