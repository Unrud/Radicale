...
def visit_time_ranges(vobject_item: vobject.base.Component, child_name: str,
    ...
    def getrruleset(child: vobject.base.Component,
                    ignore: Sequence[date]) -> Tuple[Iterable[date], bool]:
    ...
    def get_children(
            components: Iterable[vobject.base.Component]) -> Iterator[
...
def simplify_prefilters(filters: Iterable[ET.Element],
                        collection_tag: str) -> Tuple[Optional[str], int, int,
                                                      bool]:
