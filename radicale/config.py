...
def parse_compound_paths(
        *compound_paths: Optional[str]) -> List[Tuple[str, bool]]:
...
class Configuration:
    ...
    def __init__(self, schema: types.CONFIG_SCHEMA) -> None:
        ...
        """
        self._schema = schema
        self._values: types.MUTABLE_CONFIG = {}
        self._configs: List[Tuple[types.CONFIG, str, bool]] = []
    ...
    def copy(self, plugin_schema: Optional[types.CONFIG_SCHEMA] = None) \
            -> "Configuration":
