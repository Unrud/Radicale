...
class ApplicationBase:
    def __init__(self, configuration: config.Configuration) -> None:
        ...
        self._encoding: str = configuration.get("encoding", "request")

    def _read_xml_request_body(
            self, environ: types.WSGIEnviron) -> Optional[ET.Element]:
    ...
    def _webdav_error_response(
            self, status: int, human_tag: str) -> types.WSGIResponse:
...
class Access:
    ...
    def __init__(self, rights: rights.BaseRights, user: str,
                 path: str) -> None:
        self._rights = rights
        self.user = user
        self.path = path
        ...
        self._parent_permissions: Optional[str] = None
